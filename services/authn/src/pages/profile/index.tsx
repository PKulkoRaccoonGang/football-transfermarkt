				...
				<div className="profile-user-page card">
					<div className="img-user-profile">
						<img
							...
							src="https://www.arsenal.com/sites/default/files/shorthand/stories/JT2Rr6Lvaf/2023-09-19T11%3A37%3A37.746Z/assets/RFfilWzU53/uefa-champions-league-star-football-logo-8dv90jbvwwhzp9c0-2560x1440.jpg"
							alt="profile-bgHome"
						/>
						<img
							className="avatar"
					...
					<div className="description-profile">Some description...</div>
				</div>
			</div>
		</>
	);
